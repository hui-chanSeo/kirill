...
st.subheader("📌 마무리하며")
st.write("""
지금까지 저의 자기소개를 읽어주셔서 진심으로 감사드립니다.  
앞으로도 전문성을 갖춘 인재로 성장하기 위해 끊임없이 배우고 도전할 것입니다.  
특히 변화하는 시대의 흐름 속에서 디지털 전환과 지속 가능한 기술에 대한 이해를 바탕으로,  
실질적이고 책임감 있는 역할을 수행할 수 있도록 최선을 다하겠습니다.

주어진 기회를 소중히 여기며, 항상 성실하고 진정성 있는 자세로 임하겠습니다.  

이상으로 자기소개를 마칩니다. 읽어주셔서 감사합니다.
""")